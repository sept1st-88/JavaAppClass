...
public class Variables {	//클래스 영역
	...
	int iv;				//인스턴트 변수
	static int cv;		//클래수 변수(static 변수)
...
//	instance variable	클래스 영역			인스턴스가 생성되었을 떄
...
//	2. 클래스 변수
//	클래스 변수를 선언하는 방법은 인스턴스 변수 앞에 static을 분이기만 하면 된다.
...
//	인스턴스 변수는 인스턴스를 생성한 후에야 사용가능하지만, 클래스 변수는 인스턴스를 생성하지 않고도 언제라도 바로 사용할 수 있다는 특징이 있으며,
